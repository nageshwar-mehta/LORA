...
// Define the pin mapping for ESP-WROOM-32
#define NSS_PIN 5    // Chip Select (CS)
#define RESET_PIN 16  // Reset
#define DIO0_PIN 17   // Interrupt Pin (if needed)

void setup() {
  // Initialize Serial Monitor
  Serial.begin(115200);
  Serial.println("SPI Continuous Data Reading Example - ESP32");
  ...
  // Initialize SPI using VSPI default pins
  SPI.begin();
